        ...
        if (citiesFirstSymbol === trashArray[indexReverseTextTrash]) {
            ...
            if (citiesFirstSymbol === citiesArray[indexReverseText]) {
                citiesArray.forEach(function (item, i, citiesMassive) {
                    if (cityLastSymbol === citiesMassive[i].charAt(0)) {
                ...
                citiesArray.splice(indexCities, 1)
                citiesArray.splice(indexRandomCities, 1)
                trashArray.push(citiesFirstSymbol)
                trashArray.push(filterMassive[randomCities]);
